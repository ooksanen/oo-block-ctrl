wp.domReady( () => {
	...
	/**
	 * Uncomment to log all available block objects to console
	console.log( wp.blocks.getBlockTypes() );
	 */

	/**
	 * Uncomment to log block names to console
	Object.values( wp.blocks.getBlockTypes() ).forEach((block) => {
	...
	// wp.blocks.unregisterBlockType( 'core/block' );  Needed for reusable blocks!
